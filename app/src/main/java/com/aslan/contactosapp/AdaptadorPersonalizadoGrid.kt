...
class AdaptadorPersonalizadoGrid(var context: Context, items:ArrayList<Contacto>) :BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if(vista == null){
            vista = LayoutInflater.from(context).inflate(R.layout.plantilla_contactos_grid,null)
    ...
    private class ViewHolder(vista:View){
        ...
        init {
            nombre = vista.findViewById(R.id.tvNombreContactoGrid)
            imagen = vista.findViewById(R.id.ivFotoContactoGrid)
        }
    }
